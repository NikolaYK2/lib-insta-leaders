...
const SvgRussianLanguage = (props: SVGProps<SVGSVGElement>, ref: Ref<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <defs>
      <pattern id="pattern0_83149_116" width="1" height="1" patternContentUnits="objectBoundingBox">
        <use transform="scale(.01389)" xlinkHref="#image0_83149_116"></use>
      </pattern>
      <image
        id="image0_83149_116"
        width="72"
...
const ForwardRef = forwardRef(SvgRussianLanguage)
